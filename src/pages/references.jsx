    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-6">
        <motion.div className="text-center mb-16"
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl lg:text-5xl stolzl-medium text-primary-dark tracking-tight">
            MEIN WERDEGANG
          </h2>
          <div className="w-24 h-1 bg-dark-slate mx-auto my-4"></div>
        </motion.div>
          ...
          {timeline.map((item, index) => (
            ...
            >
              <div className="flex-1 space-y-3 text-center lg:text-left">
                <div className="text-2xl stolzl-medium text-primary-dark">{item.year}</div>
                <h3 className="text-xl stolzl-medium text-primary-dark tracking-wider">{item.title}</h3>
                <p className="stolzl-light text-secondary-gray leading-relaxed">{item.description}</p>
              </div>
              <div className="w-4 h-4 bg-dark-slate rounded-full flex-shrink-0"></div>
